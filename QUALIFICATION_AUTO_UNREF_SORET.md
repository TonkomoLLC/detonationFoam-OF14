...
The v1.1.0 release incorporates the production implementation that passed the Candidate 1 compile/runtime gates, together with the corrected Runtime Gate 1 qualification harness. The release changes only diagnostic/version wording relative to the runtime-qualified production source; the numerical algorithms and dictionary behavior are unchanged.
